...
interface Collector<T> extends UnaryFunction<T, T>{
    T result(); //Extract result of collecting parameters
}
interface UnaryPerdicate <T>{ boolean test(T x);}
...
public class Functional {
    ...
    public static <T> List<T> filter(Iterable<T> seq, UnaryPerdicate<T> predicate){
